...
public class BaseTestClass extends driverFactory {
	...
	public BaseTestClass() {
		...
		this.setExcelrowid(new Excelrowid());
	}
	...
	public void setExcelrowid(Excelrowid getrowid) {
	...
	public void failedResult(String actualResult, String foldername) throws IOException {
		int rowid = getrowid.getExcelRowID(foldername);
		String filename = System.currentTimeMillis() + ".png";
		String extentReportImage = System.getProperty("user.dir") + "/Result/" + foldername + "/Screenshots/"
				+ filename;
		String imgAbsolutePath = "Screenshots/" + filename;
		...
		writeToExcel.WriteDataIntoExcelCell(rowid, 4, "fail");
	}

	public void failedResultContext(String actualResult, String foldername, Page pgdriver) throws IOException {
		int rowid = getrowid.getExcelRowID(foldername);
		String filename = System.currentTimeMillis() + ".png";
		String extentReportImage = System.getProperty("user.dir") + "/Result/" + foldername + "/Screenshots/"
				+ filename;
	...
	public void uploadxrayresults(String testName, String testresult) {
